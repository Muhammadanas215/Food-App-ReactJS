...
//             const q = query(collection(db, "FOOD_DISHES"), where("restaurantID", "==", clickedRestaurantId));

// const querySnapshot = await getDocs(q);
// querySnapshot.forEach((doc) => {
//   // doc.data() is never undefined for query doc snapshots
//   console.log(doc.id, " => ", doc.data());
//   let selectedRestaurantDishesClone = selectedRestaurantDishes.slice(0)
//   selectedRestaurantDishesClone.push(doc.data())
//   setSelectedRestaurantDishes(doc.data())
// });
            ...
            <br />
                ...
                <div style={{width: '100%', display: 'flex', justifyContent: 'center', flexWrap: 'wrap'}}>
                {
                    selectedRestaurantDishes.map( (foodDish, index) => (
                                    ...
                                    <CustomerSideCard key={index} itemImage={foodDish.itemImg} itemName={foodDish.itemName} itemPrice={foodDish.itemPrice} itemDeliveryType={foodDish.itemDeliveryType} itemsRestaurantId = {foodDish.restaurantID} /> : null
