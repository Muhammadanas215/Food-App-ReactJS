...
function CustomerHome() {
    ...
    return (
        <div>
            ...
            <h1 style= {{textDecoration:'underline', textTransform:'uppercase', color:'grey'}}>
                Welcome {datas.username}
            </h1>
            <br/>
            <h3 style= {{textDecoration:'underline', textTransform:'uppercase', color:'grey'}}>
            Choose Your Restaurant For Your Food
            </h3>
